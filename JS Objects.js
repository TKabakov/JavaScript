...
console.log(house3);//{ rooms: 4, color: 'brown', priceUSD: 12345 }
...
car2["speed"] = 200;
car2.speed = 150;
console.log(car2);//{ color: 'green', speed: 150 }

/*
With the brackets notation, I can add space characters inside property names
*/
car2["number of doors"] = 4;
console.log(car2);//{ color: 'green', speed: 150, 'number of doors': 4 }
/*
 I can add numbers (as the string data type) as property keys
*/
car2["2022"] = 1901;
console.log(car2);//{ '2022': 1901, color: 'green', speed: 150, 'number of doors': 4 }
